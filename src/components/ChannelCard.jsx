...
const ChannelCard = ({ channelDetail, marginTop, bd }) => {
  return (
    <Box sx= {{
      boxShadow:"none",
      display: "flex",
      ...
      <Link to={`/channel/${channelDetail?.id?.channelId}`}>
       <CardContent sx={{ display: "flex", flexDirection: "column", justifyContent: "center", textAlign:"center", color:"#fff"}}>
        ...
        {channelDetail?.statisticts?.subscriberCount && (
          <Typography>{parseInt(channelDetail?.statisticts?.subscriberCount).toLocaleString()} Subscribers</Typography>
        )}
       </CardContent>
      </Link>
    </Box>
